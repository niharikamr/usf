...
# ************************ Here we Play the video and Record the data ************************
	...
	def create_record(self, 
		...
		MovieEndTime= time.time()
		print (MovieStartTime , " Dis da start timeee ", datetime.utcfromtimestamp(MovieStartTime).strftime('%Y-%m-%dT%H:%M:%S'))
		#pygame.quit()
		print (MovieStartTime , " Dis da start timeee ", datetime.utcfromtimestamp(MovieStartTime).strftime('%Y-%m-%dT%H:%M:%S'))
		print (MovieEndTime , " Dis da end timeee " , datetime.utcfromtimestamp(MovieEndTime).strftime('%Y-%m-%dT%H:%M:%S'))
	...
	def export_record(self, 
		...
		print("export_types", export_types)
	...
	def create_and_export_record(self,
		...
		# need disconnect headset before export
#	self.subRequest(record_export_data_types)
...
user = {
	"client_id" : "fLOVo3FKOE3Y0GNtzfdspBlgpR2uxM15EgvRMuhY",
	"client_secret" : "CwK6SIuWt32wNr87Pnuhd2XC0isYQO6vawDQI0a5er1p8wvCAYvIJQKGSLjSYkh1SfjMS2GuroCwhsR9PBjsDaYPntguG13gGXBAavoAUnjZIkXNyFiHSj7Pt9uAgSzk",
	"debit" : 100,
	"number_row_data" : 10
}
...
# export parameter
record_export_folder = '/Users/sarvi/PycharmProjects/BCI/Project/datasets/p6'
record_export_data_types = ["pow"]  # MOTION, PM, BP
...
vid_url = '/Users/sarvi/PycharmProjects/BCI/Project/Videos/1.mp4'
# record parameter
record_name = str(participant_name) + '_vid_1'
record_description = str(record_name) + '_record_for_vid_1'
...
#
# vid_id = 2
# vid_url = str(vid_id) + '.mp4'
# # record parameter
# record_name = str(participant_name) + '_vid_' + vid_url
# record_description = str(record_name) + '_record_for_vid_' + vid_url
#
#
# c.create_and_export_record(	record_name,
# 							record_description,
